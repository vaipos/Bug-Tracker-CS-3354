...
const Top = () => {
  ...
  <div className="ml-10 hero-content flex-col lg:flex-row-reverse h-72">
    ...
    <div>
      <h1 className="animate-pulse text-8xl font-bold ">BugTracker</h1>
      ...
      <details className="dropdown mb-40">
        <summary className="hover: backdrop-blur-sm m-1 btn bg-indigo-100 text-black hover:bg-indigo-200">CHOOSE TESTER OR DEVELOPER</summary>
